...
ActiveRecord::Schema.define(:version => 20121210034605) do
  ...
  add_index "states", ["psa_id"], :name => "index_states_on_psa_id"
  ...
  add_index "zips", ["psa_id"], :name => "index_zips_on_psa_id"
