...
class FrequenciesControllerTest < ActionController::TestCase
  ...
  test "should create frequency" do
    assert_difference('Frequency.count') do
      post :create, frequency: { endDate: @frequency.endDate, frequencyInterval: @frequency.frequencyInterval, startDate: @frequency.startDate }
    end
  ...
  test "should update frequency" do
    put :update, id: @frequency, frequency: { endDate: @frequency.endDate, frequencyInterval: @frequency.frequencyInterval, startDate: @frequency.startDate }
    assert_redirected_to frequency_path(assigns(:frequency))
  end
