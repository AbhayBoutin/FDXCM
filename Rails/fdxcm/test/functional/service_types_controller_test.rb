...
class ServiceTypesControllerTest < ActionController::TestCase
  ...
  test "should create service_type" do
    assert_difference('ServiceType.count') do
      post :create, service_type: { endDate: @service_type.endDate, serviceType: @service_type.serviceType, startDate: @service_type.startDate }
    end
  ...
  test "should update service_type" do
    put :update, id: @service_type, service_type: { endDate: @service_type.endDate, serviceType: @service_type.serviceType, startDate: @service_type.startDate }
    assert_redirected_to service_type_path(assigns(:service_type))
  end
